---
name: crew-medium
description: Dockmaster crewmate at medium reasoning effort. Selected with subagent_type at dispatch; defaults to the sonnet model, which the spawn's model parameter overrides.
effort: medium
model: sonnet
---
...
This definition sets two things: your reasoning effort (medium), and sonnet as the
