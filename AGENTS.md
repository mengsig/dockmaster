...
<!-- contextgraph:index:v2 [{"key":"reference-implementation","kind":"decision","digest":"3f28e6e855b8d029"},{"key":"work-boundary","kind":"invariant","digest":"b5c8ba07fc56b099"},{"key":"contextgraph-scope","kind":"pitfall","digest":"8251d4241a9f7b00"},{"key":"pr-description-style","kind":"convention","digest":"5935da3a85040db4"}] -->
Repository memory index: `reference-implementation` (decision), `work-boundary` (invariant), `contextgraph-scope` (pitfall), `pr-description-style` (convention)
